...
#[test]
fn test_f32_encoding_julia_zeros_nbits_16() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/zeros_f32.bin");
    let expected_path = testdata_dir.join("julia/zeros_f32_nbits16.bin");
...
#[test]
fn test_f32_encoding_julia_zeros_nbits_8() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/zeros_f32.bin");
    let expected_path = testdata_dir.join("julia/zeros_f32_nbits8.bin");
...
#[test]
fn test_f32_encoding_julia_zeros_nbits_24() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/zeros_f32.bin");
    let expected_path = testdata_dir.join("julia/zeros_f32_nbits24.bin");
...
#[test]
fn test_f32_encoding_julia_constants_nbits_16() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/constants_f32.bin");
    let expected_path = testdata_dir.join("julia/constants_f32_nbits16.bin");
...
#[test]
fn test_f32_encoding_julia_random_nbits_16() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/random_f32.bin");
    let expected_path = testdata_dir.join("julia/random_f32_nbits16.bin");
...
#[test]
fn test_f32_encoding_julia_edge_nbits_16() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/edge_f32.bin");
    let expected_path = testdata_dir.join("julia/edge_f32_nbits16.bin");
...
#[test]
fn test_f64_encoding_julia_zeros_nbits_32() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/zeros_f64.bin");
    let expected_path = testdata_dir.join("julia/zeros_f64_nbits32.bin");
...
#[test]
fn test_f64_encoding_julia_random_nbits_32() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/random_f64.bin");
    let expected_path = testdata_dir.join("julia/random_f64_nbits32.bin");
...
#[test]
fn test_f64_encoding_julia_edge_nbits_32() {
    let testdata_dir = Path::new(TESTDATA_DIR);
    let input_path = testdata_dir.join("inputs/edge_f64.bin");
    let expected_path = testdata_dir.join("julia/edge_f64_nbits32.bin");
